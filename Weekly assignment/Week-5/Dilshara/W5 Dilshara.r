...
# Calculate the total number of fires by state
...
print(f"Number of forest fires in {max_state}: {max_value}")

# Find the state with the minimum number of forest fires
...
print(f"Number of forest fires in {min_state}: {min_value}")
